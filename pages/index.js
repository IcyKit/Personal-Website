    ...
    <Container>
      ...
      <Box display={{ md: "flex" }}>
        <Box flexGrow={1}>
          ...
          <p>Digital Creator (Developer / Designer / Gamer)</p>
        </Box>
        <Box
          flexShrink={0}
          mt={{ base: 4, md: 0 }}
      ...
      <Section delay={0.3}>
        ...
        <Paragraph>
          Development, Crypto, Blockchain, NFT, {' '} 
          <Link href="https://shikimori.one/IcyKit/list/anime/order-by/name">
            Anime
          </Link>
          , {' '} 
          <Link href="https://www.behance.net/icykit">
            Design
          </Link>
          , Music 
        </Paragraph>
