      ...
      <Container mt={4}>
        ...
        <Section delay={0.2}>
          <List spacing={4} fontSize={16}>
            <ListItem>
              <ListIcon as={BiPlanet} w={5} h={5} />
              <b>OS</b> - macOS
            </ListItem>
            <ListItem>
              <ListIcon as={BsCode} w={5} h={5} />
              <b>Code Editor</b> - VS Code & Neovim
            </ListItem>
            <ListItem>
              <ListIcon as={BsTerminal} w={5} h={5} />
              <b>Terminal</b> - iTerm2, Tmux
            </ListItem>
            <ListItem>
              <ListIcon as={GiTurtleShell} w={5} h={5} />
              <b>Shell</b> - Zsh, powerlevel10k
            </ListItem>
            <ListItem>
              <ListIcon as={BsWindowSidebar} w={5} h={5} />
              <b>Window Manager</b> - Rectangle
            </ListItem>
            <ListItem>
              <ListIcon as={BsLaptop} w={5} h={5} />
              <b>Laptop</b> - MacBook M1 16/256
            </ListItem>
            <ListItem>
              <ListIcon as={BsDisplay} w={5} h={5} />
              <b>Display</b> - Samsung LC32JG54 144Hz, 2560x1440, 32'
            </ListItem>
            <ListItem>
              <ListIcon as={BsKeyboard} w={5} h={5} />
              <b>Keyboard</b> - Motospeed CK62 Red
            </ListItem>
            <ListItem>
              <ListIcon as={BsMouse} w={5} h={5} />
              <b>Mouse</b> - Magic Mouse 2
            </ListItem>
            <ListItem>
              <ListIcon as={GiAudioCassette} w={5} h={5} />
              <b>Audiocard</b> - Focusrite Scarlett 2i2 3rd Gen
            </ListItem>
            <ListItem>
              <ListIcon as={BsSpeaker} />
        ...
        <Section delay={0.6}>
          <List spacing={4} fontSize={16}>
            ...
            <ListItem>
              <ListIcon as={BsFileSpreadsheetFill} w={5} h={5} />
              <b>Case</b> - Corsair 740 Air
            </ListItem>
            <ListItem>
              <ListIcon as={GoCircuitBoard} w={5} h={5} />
              <b>Motherboard</b> - ASUS PRIME Z270-A
            </ListItem>
            <ListItem>
              <ListIcon as={GiComputerFan} w={5} h={5} />
            ...
            <ListItem>
              <ListIcon as={BsHeadphones} w={5} h={5} />
            ...
            <ListItem>
              <ListIcon as={BsSpeaker} w={5} h={5} />
              <b>Studio Monitors</b> - Presonus Eris E5
            </ListItem>
            <ListItem>
              <ListIcon as={BiMicrophone} w={5} h={5} />
              <b>Microphone</b> - SE Electronics X1S
            </ListItem>
            <ListItem>
              <ListIcon as={MdOutlinePadding} w={5} h={5} />
